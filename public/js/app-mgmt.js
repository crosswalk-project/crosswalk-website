...
// 17 columns
var cols = ["appid","status","name","email","submitDate","author","publishDate","downloads","price","size","architecture","xdk","category","version","notes","storeUrl","authorUrl","image"];

var colLabels = ["ID","Status","Name","Email","Submit Date","Author","Publish Date","Downloads","Price","Size","Architecture","XDK","Category","Version","Notes","Store URL","Author URL","Image Name"];
